...
WebUI.setText(findTestObject('Object Repository/Page_Pembayaran  Resellerindo/input_Rp_nominal'), '12000')

WebUI.click(findTestObject('Object Repository/Page_Pembayaran  Resellerindo/button_Pesan'))

WebUI.click(findTestObject('Object Repository/Page_Pembayaran  Resellerindo/h4_Gunakan Voucher'))

WebUI.click(findTestObject('Object Repository/Page_Pembayaran  Resellerindo/div_Gunakan VoucherCOBABonus  20COBA'))
